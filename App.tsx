...
const AppContent: React.FC = () => {
  ...
  const renderContent = () => {
    switch (currentSection) {
      ...
      case Section.EXAMS:
        return <Exams user={user} onTriggerLogin={handleTriggerLogin} />;
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><button onClick={() => setCurrentSection(Section.EXAMS)} className="hover:text-brand-primary transition-colors">Exámenes Simulacro</button></li>
